        ...
        <section class="section-9 pt-4">
            <div class="container">
                <form role="form" method="POST" id="orderForm" name="orderForm"
                    ...
                    action="{{ route('front.processCheckout') }}">
                    @csrf
                                ...
                                <div class="card-body p-0" id="split-payment_div">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="no_of_people" id="no_of_people"
                                                class="form-control" placeholder="No of People" onkeyup="calculate()">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="no_of_people_paid_for" id="no_of_people_paid_for"
                                                class="form-control" placeholder="No of People you paid for"
                                                onkeyup="calculate()">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Each Receipt Amount: </p>
                                        <div id="rec_amount" class="fw-bold"></div>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Your Paid Amount: </p>
                                        <div id="paid_amount" class="fw-bold"></div>
...
@section('customJs')
    ...
    <script>
        ...
        function calculate() {
            let x = parseFloat($("#no_of_people").val().trim());
            let y = parseFloat($("[name=grandTotal]").val().trim()); // Added $ after parseFloat
            let z = Math.round(y / x);
            $("#rec_amount").html(z);

            let a = parseFloat($("#no_of_people_paid_for").val().trim());
            let c = Math.round(a * z);
            $("#paid_amount").html(c);
            $("[name=paid_amount]").val(c);
        }
    </script>
@endsection
