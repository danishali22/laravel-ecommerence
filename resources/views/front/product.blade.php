                                    ...
                                    <div class="col-md-12 mt-5">
                                        ...
                                        @if ($product->product_ratings->isNotEmpty())
                                            ...
                                            <div class="rating-group mb-4">
                                                <span> <strong>{{ $rating->name }} </strong></span>
                                                <div class="star-rating mt-2" title="">
                                                    <div class="back-stars">
                                                        <i class="fa fa-star" aria-hidden="true"></i>
                                                        <i class="fa fa-star" aria-hidden="true"></i>
                            ...
                            @foreach ($relatedProducts as $relProduct)
                                ...
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        ...
                                        <a onclick="addToWishlist({{ $relProduct->id }})" class="whishlist"
                ...
                success: function(response) {
                    ...
                    if (response['status'] == true) {
                        ...
                        $('#comment').removeClass('is-invalid').siblings('p').removeClass(
                            'invalid-feedback').html("");
                        $('.product-rating-error').removeClass('invalid-feedback').html("");
                        ...
                        if (errors['comment']) {
                            $('#comment').addClass('is-invalid').siblings('p').addClass('invalid-feedback')
                                .html(errors['comment']);
                        } else {
                            $('#comment').removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html("");
                        ...
                        if (errors['rating']) {
                            $('.product-rating-error').addClass('text-danger').html(errors['comment']);
                        } else {
