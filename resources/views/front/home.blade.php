        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_assets/images/carousel-1-m.jpg') }}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_assets/images/carousel-2-m.jpg') }}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_assets/images/carousel-3-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front_assets/images/carousel-3.jpg') }}" />
                        <img src="{{ asset('front_assets/images/carousel-3.jpg') }}" alt="" />
                    </picture>
