        ...
        <div class="container">
            <div class="row">            
                <div class="col-md-3 sidebar">
                        ...
                        <div class="card-body">
                            @if ($brands->isNotEmpty())
                                ...
                                <div class="form-check mb-2">
                                    <input {{ in_array($brand->id, $brandsArray) ? 'checked' : '' }} class="form-check-input brand-label" type="checkbox" value="{{$brand->id}}" name=brand[] id="flexCheckDefault" id="brand-{{$brand->id}}">
                    ...
                    <div class="card">
                        <div class="card-body">
                           <input type="text" class="js-range-slider" name="my_ranger">
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                            ...
                            <div class="col-md-4">
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        ...
                                        <img class="card-img-top" src="{{asset('uploads/product/small/'.$productImage->image)}}" alt="Product Image">
                                        @else
                                        <img class="card-img-top" src="{{asset('admin_assets/img/default-150x150.png')}}" alt="Product Image">
                                        @endif
                                    </a>
