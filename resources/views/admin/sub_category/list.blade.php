        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <button type="reset" onclick="window.location.href='{{route('sub-categories.index')}}'" class="btn btn-sm btn-default">Reset</button>
                </div>
                    ...
                    <tbody>
                        @if($subCategories->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>{{$subCategory->showHome == 'Yes' ? 'Yes' : 'No'}}</td>
                            <td>
