        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <button type="reset" onclick="window.location.href='{{route('coupons.index')}}'" class="btn btn-sm btn-default">Reset</button>
                </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @if($discountCoupon->isNotEmpty())
                            @foreach($discountCoupon as $coupon)
                            <tr>
                                <td>{{$coupon->id}}</td>
                                <td>{{$coupon->code}}</td>
                                <td>{{$coupon->name}}</td>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="deleteCategory({{$coupon->id}})" class="text-danger w-4 h-4 mr-1">
